...
import com.appdavide.roundtimer.broadcasts.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context){
            Log.d("TAG", "LOG SHOW TIMER EXPIRED")
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long, typecurrent: String){
            Log.d("TAG", "LOG SHOW TIMER RUNNING")
        ...
        fun showTimerPaused(context: Context){
            Log.d("TAG", "LOG SHOW TIMER PAUSED")
